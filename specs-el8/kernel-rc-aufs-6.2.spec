...
# kernel-rc-aufs, devel, headers, perf, tools and bpftool.
%ifarch x86_64
%define with_doc 0
...
# Packages that need to be present before kernel-rc-aufs is installed
...
BuildRequires: bash bc binutils bison bzip2 diffutils elfutils-devel epel-release findutils
...
BuildRequires: flex java-devel libtraceevent-devel newt-devel numactl-devel
...
# and obsoletes for the kernel-rc-aufs package.
...
#
# This macro creates a kernel-rc-aufs-<subpackage>
...
# compression of the kernel-rc-aufs module files.
#
...
# Remove all the files that will be auto generated by depmod at the kernel-rc-aufs install time.
pushd $RPM_BUILD_ROOT/lib/modules/$KernelVer > /dev/null
%{__rm} -f modules.{alias*,builtin.bin,dep*,*map,symbols*,devname,softdep}
popd > /dev/null
...
# Compute a content hash to export as Provides: kernel-rc-aufs-headers-checksum.
...
#
# This macro defines the %%files sections for the kernel-rc-aufs package
# and its corresponding devel package.
...
- The second release candidate of a kernel-rc package set for EL8.

* Tue Jul 02 2019 Alan Bartlett <ajb@elrepo.org> - 5.1.15-0.rc1
- [https://www.kernel.org/pub/linux/kernel/v5.x/ChangeLog-5.1.15]
- The first release candidate of a kernel-rc package set for EL8.
